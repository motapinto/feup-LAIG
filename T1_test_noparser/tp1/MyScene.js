...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        //BALCAO
        this.balcaoCenter = new MyCylinder(this, 1, 1, 1.5, 4, 4);
        this.balcaoTop = new MyCylinderTops(this, 1, 1, 1.5, 4, 4, 5);
