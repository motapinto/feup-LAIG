...
class MySceneGraph {
    ...
    parsePrimitives(primitivesNode) {
        ...
        for (var i = 0; i < children.length; i++) {
          ...
          if (grandChildren.length != 1)
            return "There must be exactly 1 primitive type (rectangle, triangle, hexagon, cylinder, sphere, torus, plane, patch, triangle2, cylinder2)"
          ...
          switch (primitiveType) {
            ...
            default:
                return "There must be exactly 1 primitive type (rectangle, triangle, cylinder, sphere, torus, plane, patch, triangle2, cylinder2)"
