        ...
        if(this.loops % 2){
            ...
            for(let i = 0; i <= max_slices; i++) {
                for(let j = 0; j < j_max; j++) {                
                    ...
                    this.texCoords.push(teta / (Math.PI*2), phi / (Math.PI*2));
                    this.texCoords.push(teta / (Math.PI*2), phi / (Math.PI*2));
            ...
            for(let i = 0; i <= max_slices; i++) {
                for(let j = 0; j < j_max; j++) {                
                    ...
                    this.texCoords.push(teta / (Math.PI*2), phi / (Math.PI*2));
                    this.texCoords.push(teta / (Math.PI*2), (Math.PI - phi) / (Math.PI*2));
                    this.texCoords.push(teta / (Math.PI*2), (phi + Math.PI) / (Math.PI*2));
                    this.texCoords.push(teta / (Math.PI*2), (2*Math.PI - phi) / (Math.PI*2));
    
                    this.texCoords.push((teta + Math.PI) / (Math.PI*2), phi / (Math.PI*2));
                    this.texCoords.push((teta + Math.PI) / (Math.PI*2), (Math.PI - phi) / (Math.PI*2));
                    this.texCoords.push((teta + Math.PI) / (Math.PI*2), (phi + Math.PI) / (Math.PI*2));
                    this.texCoords.push((teta + Math.PI) / (Math.PI*2), (2*Math.PI - phi) / (Math.PI*2));
                }
            }
