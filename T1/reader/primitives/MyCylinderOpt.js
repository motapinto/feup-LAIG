        ...
        if(this.slices % 2){
          ...
          for(var i = 0; i <= this.stacks; i++){
            for(var j = 0; j < j_max; j++){
              var x = Math.cos(delta_ang*j);
              var y = Math.sin(delta_ang*j);

              this.normals.push(x, y, 0);   //1st Quadrant
              this.normals.push(-x, y, 0);  //2nd Quadrant
              this.normals.push(-x, -y, 0); //3rd Quadrant
              this.normals.push(x, -y, 0);  //4th Quadrant
